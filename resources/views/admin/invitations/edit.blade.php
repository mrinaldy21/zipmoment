                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                        ...
                                        <label class="relative cursor-pointer group" id="template-card-elegant">
                                            ...
                                            <div class="template-box overflow-hidden rounded-2xl border-2 border-gray-100 bg-white relative">
                                                <!-- ACTIVE BADGE -->
                                                <div class="template-active {{ old('template', $invitation->template) == 'elegant' ? '' : 'hidden' }} absolute top-2 left-2 text-[10px] bg-indigo-600 text-white px-2 py-1 rounded-full font-bold z-20">
                                                    ACTIVE
                                                </div>  
                                        ...
                                        <label class="relative cursor-pointer group" id="template-card-minimalist">
                                            <input type="radio" name="template" value="minimalist" class="peer sr-only" {{ old('template', $invitation->template) == 'minimalist' ? 'checked' : '' }}>
                                            <div class="template-box overflow-hidden rounded-2xl border-2 border-gray-100 bg-white relative">
                                                <!-- ACTIVE BADGE -->
                                                <div class="template-active {{ old('template', $invitation->template) == 'minimalist' ? '' : 'hidden' }} absolute top-2 left-2 text-[10px] bg-indigo-600 text-white px-2 py-1 rounded-full font-bold z-20">
                                                    ACTIVE
                                                </div>  
                                        ...
                                        <label class="relative cursor-pointer group" id="template-card-floral">
                                            <input type="radio" name="template" value="floral" class="peer sr-only" {{ old('template', $invitation->template) == 'floral' ? 'checked' : '' }}>
                                             <div class="template-box overflow-hidden rounded-2xl border-2 border-gray-100 bg-white relative">
                                                <!-- ACTIVE BADGE -->
                                                <div class="template-active {{ old('template', $invitation->template) == 'floral' ? '' : 'hidden' }} absolute top-2 left-2 text-[10px] bg-indigo-600 text-white px-2 py-1 rounded-full font-bold z-20">
                                                    ACTIVE
                                                </div>  
                                        ...
                                        <label class="relative cursor-pointer group" id="template-card-romantic">
                                            <input type="radio" name="template" value="romantic" class="peer sr-only" {{ old('template', $invitation->template) == 'romantic' ? 'checked' : '' }}>
                                             <div class="template-box overflow-hidden rounded-2xl border-2 border-gray-100 bg-white relative">
                                                <!-- ACTIVE BADGE -->
                                                <div class="template-active {{ old('template', $invitation->template) == 'romantic' ? '' : 'hidden' }} absolute top-2 left-2 text-[10px] bg-indigo-600 text-white px-2 py-1 rounded-full font-bold z-20">
                                                    ACTIVE
                                                </div>  
                                        ...
                                        <label class="relative cursor-pointer group" id="template-card-modern">
                                            ...
                                            <div class="template-box overflow-hidden rounded-2xl border-2 border-gray-100 bg-white relative">
                                                <!-- ACTIVE BADGE -->
                                                <div class="template-active {{ old('template', $invitation->template) == 'modern' ? '' : 'hidden' }} absolute top-2 left-2 text-[10px] bg-indigo-600 text-white px-2 py-1 rounded-full font-bold z-20">
                                                    ACTIVE
                                                </div>  
                                        ...
                                        <!-- Cinematic Card (Exclusive) -->
                                        <label class="relative cursor-pointer group" id="template-card-cinematic">
                                            <input type="radio" name="template" value="cinematic" class="peer sr-only" {{ old('template', $invitation->template) == 'cinematic' ? 'checked' : '' }}>
                                            <div class="template-box overflow-hidden rounded-2xl border-2 border-gray-100 bg-white relative">
                                                <!-- ACTIVE BADGE -->
                                                <div class="template-active {{ old('template', $invitation->template) == 'cinematic' ? '' : 'hidden' }} absolute top-2 left-2 text-[10px] bg-indigo-600 text-white px-2 py-1 rounded-full font-bold z-20">
                                                    ACTIVE
                                                </div>  
