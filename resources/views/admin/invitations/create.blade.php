        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('admin.invitations.store') }}" method="POST" enctype="multipart/form-data" class="space-y-12" id="createInvitationForm">
                        @csrf
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 bg-rose-50/30 p-6 rounded-lg border border-rose-100">
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <textarea name="thank_you_message" rows="4" placeholder="Ex: Merupakan suatu kebahagiaan bagi kami apabila Bapak/Ibu/Saudara/i berkenan hadir..." class="w-full text-sm border-gray-300 rounded-md">{{ old('thank_you_message') }}</textarea>
